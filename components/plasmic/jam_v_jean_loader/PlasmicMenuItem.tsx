...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: plmAgyhhAdMc/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wu1T4)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__t9JY)}>
            <div
              className={classNames(
                projectcss.all,
