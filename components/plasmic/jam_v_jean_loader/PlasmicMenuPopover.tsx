...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: _rdh0nLceaRv/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__eYe0)}
                    value={"item1"}
                  />
