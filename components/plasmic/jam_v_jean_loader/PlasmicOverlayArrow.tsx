...
import sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: WOFOuKi5Hmpy/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: J5lvhXcueeto/icon
