...
import Radio from "../../Radio"; // plasmic-import: MD_37ZQMm9eE/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: Hw_3fYzjBjtr/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__dkXfP)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__y9Qe0)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__svQwh)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__vz7Ib)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
