...
import sty from "./PlasmicModal.module.css"; // plasmic-import: fsC3QwUZz9uz/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_zjxfrxG90xGM"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___7IsZ2)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__pcOne)}
                    >
                      <Button
                        color={"muted"}
                        label={
