...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: WOFOuKi5Hmpy/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: hUsSGqcf_DAy/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__gUq4W)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__bJ8L3)}
            label={"Open Popover"}
          />
        ),
