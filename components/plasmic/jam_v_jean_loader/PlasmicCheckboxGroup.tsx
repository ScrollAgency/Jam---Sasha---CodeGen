...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: tmVEtrqiq-__/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___7Moff)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__cNDsR)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__c15OG)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ej15M)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
