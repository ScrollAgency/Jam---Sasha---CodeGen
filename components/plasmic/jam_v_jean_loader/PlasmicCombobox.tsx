...
import MenuPopover from "../../MenuPopover"; // plasmic-import: _rdh0nLceaRv/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: Os35ykAnzIHw/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__i2DKb)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__qkZA)}>
            <ChevronDown2Icon
