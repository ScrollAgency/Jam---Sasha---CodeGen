...
import Check2Icon from "./icons/PlasmicIcon__Check2"; // plasmic-import: 20TZRi7Go_b5/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: 22Wovx3Cyb_t/icon
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Check2Icon
          className={classNames(projectcss.all, sty.svg__ihei1)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg___92A12)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
