  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__smEYm, {
          [sty.freeBoxcolor_neutral__smEYmUe2T0]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          ...
          [sty.freeBoxsize_extraLarge__smEYmAvmKh]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__smEYmHgKbs]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__smEYmQdx94]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__smEYmZ70Ps]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__smEYm73IMh]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__smEYm73IMhLiprs]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__em9G2, {
            [sty.freeBoxcolor_neutral__em9G2Ue2T0]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__em9G2LqsZ]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__em9G2AvmKh]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__em9G2Qdx94]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__em9G2Z70Ps]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__em9G273IMh]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__em9G2J3AqvUe2T0]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__bKfaF)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__mnnn5, {
            [sty.freeBoxiconEnd__mnnn5G9ZQp]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__mnnn5AvmKh]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__mnnn5Qdx94]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__mnnn5Z70Ps]: hasVariant(
              $state,
              "size",
              "small"
            )
