...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: MD_37ZQMm9eE/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__kNNmV)}>
        <div className={classNames(projectcss.all, sty.freeBox___9Diov)} />
      </div>
      {renderPlasmicSlot({
